...
```
.
├── 01_Perkenalan_Pemrograman_Kompetitif (4/5)
│   ├── A. Perkenalan Soal Implementasi ✅
│   ├── P1. Operasi Matriks
│   ├── P2. Runtuh ✅
│   ├── P3. Menyelidiki Pesan ✅
│   └── P4. Pola String ✅
├── 02_Matematika_Diskret_Dasar (9/10)
...
│   ├── A. Kupon Berhadiah ✅
│   ├── B. Kualitas Baju ✅
│   ├── C. Pertemuan Pak Dengklek ✅
│   ├── D. Tukar karTu ✅
│   ├── E. Pendataan Berat Bebek ✅
│   ├── F. Barisan Hewan Ternak ✅
│   └── P1. Lari Jauh ✅
├── 04_Brute_Force (1/9)
│   ├── A. Hapus Satu Saja! ✅
│   ├── B. Brankas Terkunci 
...
│   └── P4. Mengangkut Bebek
├── 07_Dynamic_Programming (1/11)
│   ├── A. Uang Kembalian
│   ├── B. Knapsack
│   ├── C. Palindrom
│   ├── D. Perkalian Matriks Bebek
│   ├── E. Jembatan
│   ├── F. Jabat Tangan
│   ├── P1. Penukaran Emas ✅
│   ├── P2. Vitamin
...
│   ├── D. Barisan Intip ✅
│   └── E. Penghancuran Batu ✅
├── 09_Perkenalan_Graph (4/5)
│   ├── B. Kandang Terbesar ✅
│   ├── C. Evolusi ✅
│   ├── D. Tantangan Dengklek
│   ├── P1. Maze ✅
│   └── P2. Knight Force ✅
├── 10_Struktur_Data_Non_Linear (0/4)
│   ├── A. Membangun Jalan Antar Kandang
│   ├── B. Hobi Batu Akik
